...
<?php  var_dump($movie->getTitle()) ?>


<form  method="POST" class="form">

<div class="form-floating m-5">
  <input type="text" name="title" class="form-control " id="title" placeholder="" autocomplete="off" value="">
  <label for="floatingInput" class="label_placeholder up-movie"></label>
</div>
<div class="form-floating m-5">
